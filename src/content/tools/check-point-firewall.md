...
cost_details: A partir de ~$3,000/año para modelos SMB. Modelos enterprise desde $15,000/año. Licencia NGTX incluye IPS, AV, Anti-Bot, SandBlast.
website: https://www.checkpoint.com
description: 'Firewall de siguiente generación con prevención de amenazas unificada que combina IPS, antivirus,
  anti-bot, inspección SSL/TLS y sandboxing en un solo motor de inspección. 23 modelos de appliance cubren
  desde sucursales hasta centros de datos con más de 1 Tbps de throughput.'
why_reference: 'Check Point es uno de los tres grandes fabricantes de firewalls empresariales junto a Palo Alto
  Networks y Fortinet. En las pruebas independientes de CyberRatings 2025, obtuvo la calificación más alta de
  efectividad de seguridad (99,59%) con la recomendación "Recommended". Fundada en 1993, inventó el firewall
  stateful y ha mantenido un liderazgo constante en el mercado de seguridad de red durante más de 30 años.'
certifications:
- ISO 27001
...
Check Point Quantum es la familia de firewalls de siguiente generación de Check Point
