...
why_reference: Druva es pionera en backup como servicio 100% cloud-native. Su arquitectura serverless elimina la necesidad
  de gestionar infraestructura de backup, reduciendo el TCO hasta un 50% frente a soluciones tradicionales.
certifications:
- ISO 27001
- SOC 2 Tipo II
- FedRAMP
...
Druva elimina la infraestructura de backup por completo: sin appliances, sin servidores de backup, sin storage dedicado. Todo se ejecuta como servicio cloud, con datos cifrados en tránsito y en reposo, y con cumplimiento de residencia de datos por región.
