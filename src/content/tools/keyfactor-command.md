...
cost_details: Licencia anual basada en número de certificados gestionados. Desde ~$20,000/año. Edición comunitaria EJBCA open source disponible.
website: https://www.keyfactor.com
description: 'Plataforma de gestión del ciclo de vida de certificados (CLM) que automatiza el descubrimiento,
  emisión, renovación y revocación de certificados digitales sobre cualquier infraestructura PKI. Compatible
  con CAs públicas y privadas, Microsoft AD CS, y preparación post-cuántica.'
why_reference: 'Keyfactor ha sido reconocido como Líder en el G2 Grid de Certificate Lifecycle Management
  en Summer 2025, con el 100% de sus reseñas de 4-5 estrellas. Su motor EJBCA es la CA open source más
  desplegada del mundo para PKI empresarial. Con más de 2,000 clientes, Keyfactor es el socio de confianza
  para organizaciones que necesitan gestionar millones de certificados con automatización completa.'
certifications:
- ISO 27001
- ISO 9001
...
Keyfactor Command es la plataforma de gestión del ciclo de vida de certificados
que permite a las organizaciones recuperar el control sobre su infraestructura PKI.
