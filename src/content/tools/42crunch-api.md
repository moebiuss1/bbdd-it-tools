...
El micro-firewall de 42Crunch se despliega como sidecar y aplica el contrato auditado en runtime: cualquier petición que viole el schema de la API es bloqueada automáticamente, eliminando clases enteras de ataques sin necesidad de reglas de WAF.
