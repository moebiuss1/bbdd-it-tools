...
cost_details: Suscripción por dominio o por volumen de tráfico. Disponible como servicio cloud o appliance en el centro de
  datos.
website: https://www.imperva.com/products/web-application-firewall-waf/
cert_url: https://www.imperva.com/trust-center/
description: Firewall de aplicaciones web con protección frente a OWASP Top 10, mitigación de DDoS, gestión de bots y seguridad
  de APIs, en modalidad cloud o local.
why_reference: Imperva es uno de los nombres fundacionales del mercado WAF y aparece de forma sostenida entre los líderes
  de cloud web application and API protection de Gartner. Su motor de reglas y su investigación de amenazas son la referencia
  con la que se comparan el resto de WAF cuando lo que importa es la tasa de falsos positivos.
certifications:
- ISO 27001
- SOC 2 Tipo II
- PCI DSS
